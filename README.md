...
4 ply；两种棋的候选都支持鼠标悬停或键盘聚焦后自动连演 4 ply。点击仍用于明确选线或真正下棋，
...
自动接续一条 4 ply 浅层分析路线；移到另一候选会立即换线，移出后恢复真实棋盘，悬停路线不会写入
...
桌面上可直接把鼠标停在五列卡片、2D 树节点、3D 标签或回应卡上看 4 ply 连演；键盘 Tab / 方向键
